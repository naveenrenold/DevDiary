import { ElementRef, OnDestroy, EventEmitter, Renderer2, QueryList, NgZone, ChangeDetectorRef, AfterContentInit, TemplateRef, OnInit, AfterViewInit } from '@angular/core';
import { AnimationEvent } from '@angular/animations';
import { Header, Footer, PrimeNGConfig, LicenseManager } from 'primeng/api';
import * as i0 from "@angular/core";
import * as i1 from "@angular/common";
import * as i2 from "primeng/focustrap";
import * as i3 from "primeng/ripple";
import * as i4 from "primeng/api";
export declare class Dialog implements AfterContentInit, OnInit, AfterViewInit, OnDestroy {
    el: ElementRef;
    renderer: Renderer2;
    zone: NgZone;
    private cd;
    ...
    styleElement: any;
    constructor(el: ElementRef, renderer: Renderer2, zone: NgZone, cd: ChangeDetectorRef, config: PrimeNGConfig, licenseManager: LicenseManager);
