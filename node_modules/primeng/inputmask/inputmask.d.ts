import { ElementRef, OnInit, EventEmitter, ChangeDetectorRef, AfterViewInit } from '@angular/core';
...
export declare class InputMask implements OnInit, AfterViewInit, ControlValueAccessor {
    el: ElementRef;
    private cd;
    ...
    focused: boolean;
    constructor(el: ElementRef, cd: ChangeDetectorRef, licenseManager: LicenseManager);
    ngOnInit(): void;
