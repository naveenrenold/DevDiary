import { ElementRef, AfterViewChecked, OnDestroy, Renderer2, EventEmitter, ChangeDetectorRef, AfterViewInit } from '@angular/core';
...
export declare class SlideMenu implements AfterViewChecked, OnDestroy, AfterViewInit {
    el: ElementRef;
    renderer: Renderer2;
    ...
    constructor(el: ElementRef, renderer: Renderer2, cd: ChangeDetectorRef, config: PrimeNGConfig, overlayService: OverlayService, licenseManager: LicenseManager);
