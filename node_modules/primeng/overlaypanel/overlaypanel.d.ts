import { OnDestroy, EventEmitter, Renderer2, ElementRef, ChangeDetectorRef, NgZone, TemplateRef, AfterContentInit, QueryList, AfterViewInit } from '@angular/core';
...
export declare class OverlayPanel implements AfterContentInit, AfterViewInit, OnDestroy {
    el: ElementRef;
    renderer: Renderer2;
    ...
    constructor(el: ElementRef, renderer: Renderer2, cd: ChangeDetectorRef, zone: NgZone, config: PrimeNGConfig, overlayService: OverlayService, licenseManager: LicenseManager);
