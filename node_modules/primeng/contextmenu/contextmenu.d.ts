...
import { MenuItem, ContextMenuService, PrimeNGConfig, LicenseManager } from 'primeng/api';
...
export declare class ContextMenu implements AfterViewInit, OnDestroy {
    ...
    constructor(el: ElementRef, renderer: Renderer2, cd: ChangeDetectorRef, zone: NgZone, contextMenuService: ContextMenuService, config: PrimeNGConfig, licenseManager: LicenseManager);
