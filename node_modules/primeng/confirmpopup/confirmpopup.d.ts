import { ElementRef, ChangeDetectorRef, OnDestroy, Renderer2, AfterViewInit } from '@angular/core';
import { Confirmation, ConfirmationService, LicenseManager, OverlayService, PrimeNGConfig } from 'primeng/api';
import { Subscription } from 'rxjs';
import { AnimationEvent } from '@angular/animations';
import * as i0 from "@angular/core";
import * as i1 from "@angular/common";
import * as i2 from "primeng/button";
export declare class ConfirmPopup implements OnDestroy, AfterViewInit {
    el: ElementRef;
    ...
    constructor(el: ElementRef, confirmationService: ConfirmationService, renderer: Renderer2, cd: ChangeDetectorRef, config: PrimeNGConfig, overlayService: OverlayService, licenseManager: LicenseManager);
