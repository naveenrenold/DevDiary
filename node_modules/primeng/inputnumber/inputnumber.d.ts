import { AfterViewInit, ChangeDetectorRef, ElementRef, EventEmitter, Injector, OnInit, SimpleChanges } from '@angular/core';
...
export declare class InputNumber implements OnInit, AfterViewInit, ControlValueAccessor {
    el: ElementRef;
    private cd;
    ...
    private ngControl;
    constructor(el: ElementRef, cd: ChangeDetectorRef, injector: Injector, licenseManager: LicenseManager);
