...
export declare class Ripple implements AfterViewInit, OnDestroy {
    ...
    constructor(el: ElementRef, zone: NgZone, config: PrimeNGConfig, licenseManager: LicenseManager);
    ...
    remove(): void;
    ngOnDestroy(): void;
    static ɵfac: i0.ɵɵFactoryDeclaration<Ripple, [null, null, { optional: true; }, null]>;
