import { OnInit, ChangeDetectorRef, EventEmitter, TemplateRef, OnChanges, SimpleChanges, AfterViewInit } from '@angular/core';
import { LicenseManager, SelectItem } from 'primeng/api';
...
export declare class Paginator implements OnInit, OnChanges, AfterViewInit {
    private cd;
    ...
    _first: number;
    _page: number;
    constructor(cd: ChangeDetectorRef, licenseManager: LicenseManager);
    ngOnInit(): void;
