import { OnDestroy, EventEmitter, AfterContentInit, ElementRef, QueryList, TemplateRef, ChangeDetectorRef, AfterViewInit } from '@angular/core';
import { Message, MessageService, LicenseManager } from 'primeng/api';
...
export declare class Messages implements AfterContentInit, OnDestroy, AfterViewInit {
    ...
    constructor(messageService: MessageService, el: ElementRef, cd: ChangeDetectorRef, licenseManager: LicenseManager);
