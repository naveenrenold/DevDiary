...
import { BlockableUI, Footer, Header, LicenseManager } from 'primeng/api';
import { Scroller, ScrollerOptions } from 'primeng/scroller';
import * as i0 from "@angular/core";
import * as i1 from "@angular/common";
import * as i2 from "primeng/api";
import * as i3 from "primeng/scroller";
export declare class VirtualScroller implements AfterContentInit, AfterViewInit, BlockableUI {
    el: ElementRef;
