...
import { FilterService, LicenseManager, OverlayOptions, PrimeNGConfig, SelectItem } from 'primeng/api';
...
export declare class Dropdown implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    ...
    labelId: string;
    listId: string;
    constructor(el: ElementRef, renderer: Renderer2, cd: ChangeDetectorRef, zone: NgZone, filterService: FilterService, config: PrimeNGConfig, licenseManager: LicenseManager);
