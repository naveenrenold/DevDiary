...
export declare class Slider implements OnDestroy, AfterViewInit, ControlValueAccessor {
    el: ElementRef;
    renderer: Renderer2;
    private ngZone;
    ...
    startx: number;
    starty: number;
    constructor(el: ElementRef, renderer: Renderer2, ngZone: NgZone, cd: ChangeDetectorRef, licenseManager: LicenseManager);
