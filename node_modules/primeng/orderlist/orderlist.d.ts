import { ElementRef, AfterViewChecked, AfterContentInit, QueryList, TemplateRef, EventEmitter, ChangeDetectorRef, AfterViewInit } from '@angular/core';
import { FilterService, LicenseManager } from 'primeng/api';
...
export declare class OrderList implements AfterViewChecked, AfterContentInit, AfterViewInit {
    ...
    visibleOptions: any[];
    _value: any[];
    constructor(el: ElementRef, cd: ChangeDetectorRef, filterService: FilterService, licenseManager: LicenseManager);
    get selection(): any[];
