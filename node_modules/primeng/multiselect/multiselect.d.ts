...
import { FilterService, LicenseManager, OverlayOptions, OverlayService, PrimeNGConfig } from 'primeng/api';
...
export declare class MultiSelect implements OnInit, AfterViewInit, AfterContentInit, AfterViewChecked, ControlValueAccessor {
    ...
    constructor(el: ElementRef, renderer: Renderer2, cd: ChangeDetectorRef, zone: NgZone, filterService: FilterService, config: PrimeNGConfig, overlayService: OverlayService, licenseManager: LicenseManager);
    ngOnInit(): void;
