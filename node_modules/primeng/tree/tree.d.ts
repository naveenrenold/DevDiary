import { AfterContentInit, OnDestroy, EventEmitter, OnInit, OnChanges, QueryList, TemplateRef, ElementRef, SimpleChanges, AfterViewInit } from '@angular/core';
import { LicenseManager, PrimeNGConfig, TreeNode } from 'primeng/api';
...
export declare class UITreeNode implements OnInit {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<UITreeNode, "p-treeNode", never, { "rowNode": "rowNode"; "node": "node"; "parentNode": "parentNode"; "root": "root"; "index": "index"; "firstChild": "firstChild"; "lastChild": "lastChild"; "level": "level"; "indentation": "indentation"; "itemSize": "itemSize"; }, {}, never, never, false>;
}
export declare class Tree implements OnInit, AfterContentInit, AfterViewInit, OnChanges, OnDestroy, BlockableUI {
    el: ElementRef;
    ...
    constructor(el: ElementRef, dragDropService: TreeDragDropService, config: PrimeNGConfig, licenseManager: LicenseManager);
    ngOnInit(): void;
