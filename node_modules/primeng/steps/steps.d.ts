import { EventEmitter, OnInit, OnDestroy, ChangeDetectorRef, AfterViewInit } from '@angular/core';
import { LicenseManager, MenuItem } from 'primeng/api';
...
export declare class Steps implements OnInit, OnDestroy, AfterViewInit {
    ...
    constructor(router: Router, route: ActivatedRoute, cd: ChangeDetectorRef, licenseManager: LicenseManager);
