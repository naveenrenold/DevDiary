import { ElementRef, OnDestroy, DoCheck, NgZone, OnInit, QueryList, TemplateRef, AfterContentInit, ChangeDetectorRef, EventEmitter, PipeTransform, AfterViewInit } from '@angular/core';
import { OverlayService, PrimeNGConfig, LicenseManager } from 'primeng/api';
import { Subscription } from 'rxjs';
import * as i0 from "@angular/core";
import * as i1 from "@angular/common";
import * as i2 from "primeng/inputtext";
import * as i3 from "primeng/api";
export declare class PasswordDirective implements OnDestroy, AfterViewInit, DoCheck {
    el: ElementRef;
    zone: NgZone;
    ...
    constructor(el: ElementRef, zone: NgZone, licenseManager: LicenseManager);
    ngDoCheck(): void;
