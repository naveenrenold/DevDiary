import { EventEmitter, ElementRef, AfterContentInit, QueryList, TemplateRef, AfterViewInit } from '@angular/core';
...
export declare class Fieldset implements AfterContentInit, AfterViewInit, BlockableUI {
    private el;
