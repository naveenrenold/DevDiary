import { ElementRef, Renderer2, OnDestroy, ChangeDetectorRef, AfterContentInit, QueryList, TemplateRef, EventEmitter, AfterViewInit } from '@angular/core';
import { LicenseManager, MenuItem, PrimeNGConfig } from 'primeng/api';
...
export declare class Menubar implements AfterContentInit, AfterViewInit, OnDestroy {
    el: ElementRef;
    renderer: Renderer2;
    ...
    constructor(el: ElementRef, renderer: Renderer2, cd: ChangeDetectorRef, config: PrimeNGConfig, licenseManager: LicenseManager);
