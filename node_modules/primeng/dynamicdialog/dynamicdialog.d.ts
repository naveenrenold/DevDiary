...
export declare class DynamicDialogComponent implements AfterViewInit, OnDestroy {
    ...
    get position(): string;
    set style(value: any);
    constructor(componentFactoryResolver: ComponentFactoryResolver, cd: ChangeDetectorRef, renderer: Renderer2, config: DynamicDialogConfig, dialogRef: DynamicDialogRef, zone: NgZone, primeNGConfig: PrimeNGConfig, licenseManager: LicenseManager);
