import { ElementRef, OnDestroy, EventEmitter, Renderer2, NgZone, ChangeDetectorRef, QueryList, TemplateRef, AfterContentInit, OnInit, AfterViewInit } from '@angular/core';
import { AnimationEvent } from '@angular/animations';
import { PrimeNGConfig, LicenseManager } from 'primeng/api';
...
export declare class ConfirmDialog implements AfterContentInit, OnInit, AfterViewInit, OnDestroy {
    el: ElementRef;
    renderer: Renderer2;
    ...
    constructor(el: ElementRef, renderer: Renderer2, confirmationService: ConfirmationService, zone: NgZone, cd: ChangeDetectorRef, config: PrimeNGConfig, licenseManager: LicenseManager);
    ngOnInit(): void;
