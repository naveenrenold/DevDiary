import { ElementRef, OnInit, AfterContentInit, EventEmitter, QueryList, TemplateRef, OnChanges, SimpleChanges, ChangeDetectorRef, OnDestroy, AfterViewInit } from '@angular/core';
import { FilterService, PrimeNGConfig, LicenseManager } from 'primeng/api';
...
export declare class DataView implements OnInit, AfterContentInit, AfterViewInit, OnDestroy, BlockableUI, OnChanges {
    el: ElementRef;
    ...
    constructor(el: ElementRef, cd: ChangeDetectorRef, filterService: FilterService, config: PrimeNGConfig, licenseManager: LicenseManager);
    ngOnInit(): void;
