import { EventEmitter, ElementRef, QueryList, TemplateRef, AfterContentInit, AfterViewInit } from '@angular/core';
...
export declare class Panel implements AfterContentInit, AfterViewInit, BlockableUI {
    private el;
