...
import { LicenseManager, Message, PrimeNGConfig } from 'primeng/api';
...
export declare class Toast implements OnInit, AfterContentInit, OnDestroy {
    ...
    template: TemplateRef<any>;
    constructor(messageService: MessageService, cd: ChangeDetectorRef, config: PrimeNGConfig, licenseManager: LicenseManager);
    styleElement: any;
    id: string;
    ngOnInit(): void;
    ngAfterViewInit(): void;
