import { ElementRef, AfterContentInit, EventEmitter, TemplateRef, QueryList, ChangeDetectorRef, OnDestroy, AfterViewInit } from '@angular/core';
...
export declare class OrganizationChartNode implements OnDestroy, AfterViewInit {
    ...
    constructor(chart: any, cd: ChangeDetectorRef, licenseManager: LicenseManager);
