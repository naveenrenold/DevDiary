...
import { BlockableUI, FilterMetadata, FilterService, LicenseManager, OverlayService, PrimeNGConfig, PrimeTemplate, SelectItem, SortMeta } from 'primeng/api';
...
export declare class Table implements OnInit, AfterViewInit, AfterContentInit, BlockableUI, OnChanges {
    ...
    constructor(el: ElementRef, zone: NgZone, tableService: TableService, cd: ChangeDetectorRef, filterService: FilterService, overlayService: OverlayService, licenseManager: LicenseManager);
    ngOnInit(): void;
