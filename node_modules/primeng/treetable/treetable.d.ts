...
import { BlockableUI, FilterMetadata, FilterService, LicenseManager, PrimeTemplate, SortMeta, TreeNode } from 'primeng/api';
...
export declare class TreeTable implements AfterContentInit, OnInit, AfterViewInit, OnDestroy, BlockableUI, OnChanges {
    el: ElementRef;
    ...
    constructor(el: ElementRef, cd: ChangeDetectorRef, zone: NgZone, tableService: TreeTableService, filterService: FilterService, licenseManager: LicenseManager);
