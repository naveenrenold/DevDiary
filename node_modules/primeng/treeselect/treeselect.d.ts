...
import { LicenseManager, OverlayOptions, OverlayService, PrimeNGConfig, TreeNode } from 'primeng/api';
...
export declare class TreeSelect implements AfterContentInit, AfterViewInit {
    ...
    constructor(config: PrimeNGConfig, cd: ChangeDetectorRef, el: ElementRef, overlayService: OverlayService, licenseManager: LicenseManager);
    ngOnInit(): void;
