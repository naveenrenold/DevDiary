import { ElementRef, Renderer2, OnDestroy, ChangeDetectorRef, EventEmitter, AfterViewInit } from '@angular/core';
import { LicenseManager, MenuItem, OverlayService, PrimeNGConfig } from 'primeng/api';
...
export declare class TieredMenuSub implements OnDestroy, AfterViewInit {
    el: ElementRef;
    renderer: Renderer2;
    private cd;
    ...
    activeItem: any;
    constructor(el: ElementRef, renderer: Renderer2, cd: ChangeDetectorRef, licenseManager: LicenseManager);
